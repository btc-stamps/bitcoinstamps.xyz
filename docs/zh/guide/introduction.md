...
### SRC-721 NFT
具有递归功能和复杂链上特性的高级非同质代币，通过<EntityMention entity="src-721" variant="technical">SRC-721</EntityMention>实现。

### OLGA 编码
压缩优化，通过<EntityMention entity="olga" variant="technical">OLGA</EntityMention>降低所有比特币印章协议的成本。
...
**[创建您的第一个印章 →](/en/tutorials/creating-first-stamp)**  
