---
title: "Novidades"
description: "Novidades, anúncios e análises técnicas da comunidade Bitcoin Stamps"
leoType: "blog"
layout: "page"
---
...
<div class="blog-listing">
  <article v-for="post in posts" :key="post.url" class="blog-post-item">
    <div class="blog-post-meta">
      <time :datetime="post.frontmatter.date">{{ new Date(post.frontmatter.date).toLocaleDateString('pt-BR', { year: 'numeric', month: 'long', day: 'numeric' }) }}</time>
    ...
    <a :href="post.url" class="blog-read-more">Leia mais &rarr;</a>
  </article>
