...
- **P2WSH işlemleri için SRC-721R dağıtım algılaması**, özyinelemeli SRC-721 açıklama ayrıştırması ve lanetli stamp'ler (cursed stamps) için daha güvenli çift işleme.
...
Bu sürüm, <EntityMention entity="bitcoin-stamps">Bitcoin Stamps</EntityMention>'i 779,652 numaralı bloktan itibaren tanımlayan aynı disiplini sürdürüyor: yeni özellikler etkinleştirme yüksekliklerinin arkasında devreye girer ve herhangi bir şey yayımlanmadan önce konsensüs gerçek zincir üzerinde kanıtlanır.
