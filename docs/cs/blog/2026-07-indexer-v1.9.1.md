...
- **Kódování <EntityMention entity="src-101">SRC-101</EntityMention> P2WSH / <EntityMention entity="olga">OLGA</EntityMention>** se aktivuje v **bloku 940,000**. Před aktivací je SRC-101 podporováno pouze přes bare multisig; po aktivaci fungují jak bare multisig, tak P2WSH, rozlišené na úrovni JSON (`"p":"src-101"`).
- **Detekce nasazení SRC-721R** pro transakce P2WSH, rekurzivní parsování popisů SRC-721 a bezpečnější dvojí zpracování prokletých stampů (cursed stamps).
